...
describe('ProductService', () => {
  ...
  it('should return all products', async () => {
    const products = await service.findAllProductService();
  ...
  //   const products = await service.findAllProductService([], true);
  ...
  //   const spy = jest.spyOn(productRepository, 'find');
  //   const products = await service.findAllProductService([1], true);
  ...
  it('should return error if products empty', async () => {
    ...
    expect(service.findAllProductService()).rejects.toThrowError();
  });
  ...
  it('should return product after insert in DB', async () => {
    const product = await service.createProductService(createProductMock);
  ...
  it('should return deleted true in delete product', async () => {
    const deleted = await service.deleteProductService(productMock.id);
